...
(function() {
  ...
  Sqlite3Driver = (function(_super) {
    ...
    function Sqlite3Driver(options) {
      this.options = options;
      Sqlite3Driver.__super__.constructor.call(this, this.options);
      loglet.debug('constructor:id', this.id);
    ...
    Sqlite3Driver.prototype.connect = function(cb) {
      var self;
      loglet.debug("" + (this.driverName()) + ".connect", this.options);
      self = this;
    ...
    Sqlite3Driver.prototype.query = function(stmt, args, cb) {
      var normedArgs, normedStmt, _ref;
      try {
