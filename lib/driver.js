...
var Driver = /** @class */ (function (_super) {
    ...
    Driver.prototype.connect = function (cb) {
        this.connectAsync()
            .then(function (driver) { return cb(null, driver); })["catch"](cb);
    };
    ...
    Driver.prototype.execScriptAsync = function (filePath) {
        ...
        return fs.readFileAsync(filePath, 'utf8')
            .then(function (data) {
            var queries = data.replace(/(--).*/g, '').split(/\s*;\s*/);
        ...
        return fs.readFileAsync(filePath, 'utf8')
            ...
            if (inTransaction) {
                return _this.beginAsync()
                    ...
                    .then(function () { return _this.commitAsync(); })["catch"](function (e) {
