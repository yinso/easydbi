...
(function() {
  ...
  NoPool = (function() {
    ...
    NoPool.prototype.prepare = function(call, options) {
      var proc;
      proc = (options != null ? options.query : void 0) ? function(args, cb) {
      ...
      } : options instanceof Function ? options : Errorlet.raise({
  ...
  Pool = (function(superClass) {
    ...
    Pool.prototype.prepare = function(call, options) {
      ...
      proc = (options != null ? options.query : void 0) ? function(args, cb) {
        ...
        return this.exec(options.exec, args, cb);
      } : (options instanceof Function) || (typeof options === 'function') ? options : Errorlet.raise({
        error: 'EASYDBI.prepare:invalid_prepare_option',
        call: call,
        options: options
      });
