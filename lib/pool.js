...
(function() {
  var Driver, EventEmitter, NoPool, Pool, Promise, loglet, _,
  ...
  NoPool = (function() {
    function NoPool(key, type, driver, connOptions, options) {
  ...
  Pool = (function(_super) {
    ...
    function Pool(key, type, driver, connOptions, options) {
      var poolDriver, self;
      this.key = key;
      this.type = type;
      this.connOptions = connOptions;
